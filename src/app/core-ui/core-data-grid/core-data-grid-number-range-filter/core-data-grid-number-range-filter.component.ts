...
@Component({
    selector: "core-data-grid-number-range-filter",
    template: require("./core-data-grid-number-range-filter.component.html")
})
export class CoreDataGridNumberRangeFilterComponent {
